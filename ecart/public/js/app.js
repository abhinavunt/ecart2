// public/js/app.js
app = angular.module('sampleApp', ['ngRoute','appRoutes','ngAnimate','MenuCtrl','AdminChartCtrl','HomeCtrl','CompleteOrderCtrl','UserCtrl','RegisteredUsersCtrl','AdminOrderCtrl','AddCtrl','HeadCtrl','ItemCtrl','GetItemCtrl','ShowItemCtrl','ngDialog','file-model','angularFileUpload','ngCookies','googlechart','infinite-scroll']);
